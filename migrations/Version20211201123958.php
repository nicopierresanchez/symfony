 ...
 */
final class Version20211201123958 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE program CHANGE category_id category_id VARCHAR(45) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`');
