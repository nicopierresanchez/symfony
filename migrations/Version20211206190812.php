 ...
 */
final class Version20211206190812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD program_id INT DEFAULT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode DROP program_id, CHANGE id id INT NOT NULL');
    }
}
